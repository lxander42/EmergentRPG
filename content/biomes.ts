...
export const BIOMES: Record<Biome, BiomeMeta> = {
  ...
  forest: {
    ...
    passable: true,
    swatch: "#8fa873",
    variants: ["forest_a", "forest_b", "forest_c", "forest_d"],
  },
  water: {
    title: "Open Water",
    ...
    passable: false,
    swatch: "#a8c8d8",
    variants: ["water_a", "water_b", "water_c", "water_d"],
  },
  sand: {
    title: "Sands",
    ...
    passable: true,
    swatch: "#e8d8b0",
    variants: ["sand_a", "sand_b", "sand_c", "sand_d"],
  },
  stone: {
    title: "Highlands",
    ...
    passable: true,
    swatch: "#b8b0a0",
    variants: ["stone_a", "stone_b", "stone_c", "stone_d"],
  },
};
